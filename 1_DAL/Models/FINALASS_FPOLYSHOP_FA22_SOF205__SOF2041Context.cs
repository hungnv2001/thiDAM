...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=.\\sqlexpress;Initial Catalog=FINALASS_FPOLYSHOP_FA22_SOF205__SOF2041;Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ChucVu>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__ChucVu__3214CC9E0381057A")
                    .IsUnique();
            ...
            modelBuilder.Entity<CuaHang>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__CuaHang__3214CC9E02C14D46")
                    .IsUnique();
            ...
            modelBuilder.Entity<DongSp>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__DongSP__3214CC9E1BD215A2")
                    .IsUnique();
            ...
            modelBuilder.Entity<GioHang>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__GioHang__3214CC9E5839A5AB")
                    .IsUnique();
            ...
            modelBuilder.Entity<HoaDon>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__HoaDon__3214CC9E253F420D")
                    .IsUnique();
            ...
            modelBuilder.Entity<KhachHang>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__KhachHan__3214CC9E6A7D2EA8")
                    .IsUnique();
            ...
            modelBuilder.Entity<MauSac>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__MauSac__3214CC9E2894A45B")
                    .IsUnique();
            ...
            modelBuilder.Entity<NhanVien>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__NhanVien__3214CC9E289FC437")
                    .IsUnique();
            ...
            modelBuilder.Entity<Nsx>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__NSX__3214CC9EEB35FFE7")
                    .IsUnique();
            ...
            modelBuilder.Entity<SanPham>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ma, "UQ__SanPham__3214CC9EB2DF4A6C")
                    .IsUnique();
